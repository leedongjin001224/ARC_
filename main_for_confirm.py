...
def done():
    training_tasks, testing_tasks, file_names = load_tasks('ARC-800-tasks/evaluation/')#load_tasks('data/evaluation/')
    ...
    with open('data/solution/solution_GIST22.json', 'w') as outfile:#open('../data/solution/solution_gist22.json', 'w') as outfile:
